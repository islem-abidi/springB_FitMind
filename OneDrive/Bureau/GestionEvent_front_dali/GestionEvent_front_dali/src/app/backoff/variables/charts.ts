// ⚠️ Import corrigé pour éviter l'erreur TS1259
import * as Chart from 'chart.js';



// Extension pour les barres avec coins arrondis
      ...
      doughnut: {
        ...
        legendCallback: function (chart: any) {
          ...
          data.labels.forEach((label: string, index: number) => {
            ...
            content += `<span class="chart-legend-item"><i class="chart-legend-indicator" style="background-color: ${bgColor}"></i>${label}</span>`;
          });
